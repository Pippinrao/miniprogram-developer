...
渲染宽高为 canvas 画布在页面中所实际占用的宽高大小，即通过对节点进行
boundingClientRect
请求获取到的大小。
...
wx.getWindowInfo
获取设备的像素比，乘上 canvas 的渲染大小，作为画布的逻辑大小。
#
第四步：进行绘制
在开发者工具中预览效果
