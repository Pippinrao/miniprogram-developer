...
boolean
否
一个自定义组件由 json、wxml、wxss、js 4个文件组成。如设置component为true，将声明这一组文件为自定义组件
styleIsolation
string
否
样式隔离
...
点击「前往控制台」
选择「我的业务--小程序」
页面右上角，切换到穿戴设备小程序要挂靠的普通小程序。
切换到「硬件设置」
点击「申请创建」
创建成功，获得「穿戴端AppID」
#
3.2 安装开发者工具拓展
打开「微信开发者工具」(需使用版本号 ≥ 2.01.2507252,建议下载最新 nightly 版开发者工具进行使用)
在「工具栏」选择「设置--拓展设置」
在弹出的页面中，左侧选择「模拟器插件」，右侧选择安装「低功耗硬件小程序模式」
#
3.3 启用低功耗小程序模式
