...
- **语义搜索知识库**: 387 个官方文档页面，608 个向量化 chunks，基于 BGE-large-zh-v1.5 + ChromaDB
- **Multi-Agent 架构**: 1 个主调度 Agent + 10 个领域专家子 Agent，协作完成需求→设计→实现→测试→验收
- **9 个开发工作流**: 覆盖项目初始化、功能开发、组件开发、云函数、测试、调试、重构、性能优化、紧急修复
...
├── official-docs/              # 微信官方文档知识库（387 页）
│   ├── framework/              # 365 个框架 API 文档
│   ├── design/                 # 22 个设计规范文档
